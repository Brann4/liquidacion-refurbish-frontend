...
export class ViewRecupero implements OnInit {
    ...
    protected onEditRecupero(recupero: LiquidacionRecupero): void {
        this.recuperoStore.openModalEdit(recupero);
    }

    protected onDeleteRecupero(recupero: LiquidacionRecupero): void {
